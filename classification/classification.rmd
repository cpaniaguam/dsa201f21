...
Content adapted from chapter 5 of [Data Science: A First
Introduction](https://ubc-dsci.github.io/introduction-to-datascience/classification.html)
by Timbers et.al.
...
```{r}
cancer = read_csv('https://raw.githubusercontent.com/ttimbers/introduction-to-datascience/master/data/clean-wdbc.data.csv')
View(cancer)
